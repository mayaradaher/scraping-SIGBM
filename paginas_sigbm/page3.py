...
def scrap_id_info(id: str) -> dict:
    ...
    id_dict1 = {("MinerioPrincipalReservatorio"): tag.get_text("value") for tag in tag1}
...
df_page3["ProdutosQuimicosUtilizados"] = df_page3["ProdutosQuimicosUtilizados"].apply(
    remove_repeated_blocks
)
...
df_page3["OutrasSubstanciasPresentes"] = df_page3["OutrasSubstanciasPresentes"].apply(
    lambda x: re.sub(r'[!=,\[\](){}\\"]', "", unidecode(str(x)))
)
...
df_page3["OutrasSubstanciasPresentes"] = df_page3["OutrasSubstanciasPresentes"].apply(
    extract_between_single_quotes_and_equal
)
...
df_page3["TeorMinerioInseridoRejeito"] = df_page3["TeorMinerioInseridoRejeito"].apply(
